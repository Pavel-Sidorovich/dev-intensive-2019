...
//            val mDrawable = PaintDrawable()
//            mDrawable.getPaint().setColor(colo)
//            mDrawable.setCornerRadius(radis)
}
...
//        mBorderPaint.color = mBorderColor
//        mBorderPaint.setStrokeWidth(mBorderWidth as Float)
//
...
//        mBorderRadius =
//            min((mBorderRect.height().minus(mBorderWidth as Float)) / 2.0f, (mBorderRect.width().minus(mBorderWidth as Float)) / 2.0f)
//
